...
import { BookOpen, Mail, Lock, LogIn, Chrome, Eye, EyeOff } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-dark-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-accent-400/5 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md animate-slide-up relative z-10">
        ...
        <div className="glass-card p-8">
          <h2 className="text-white font-bold text-xl mb-1">Selamat datang kembali 👋</h2>
          <p className="text-slate-500 text-sm mb-6">Masuk untuk melanjutkan belajarmu</p>
